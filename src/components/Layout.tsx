...
// import React, { ReactNode, useState } from "react";
// import { useAuth } from "../contexts/AuthContext";
// import { Globe, User, LogOut, Menu, X, Facebook, Twitter, Instagram, Linkedin, Github } from "lucide-react";
...
//   return (
//     <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-gray-900 to-gray-800 text-gray-100">
//       {/* Navigation */}
//       <nav className="bg-white/5 backdrop-blur-xl shadow-lg border-b border-white/10 sticky top-0 z-50">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="flex justify-between h-16">
...
//               <span className="ml-2 text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
//                 <img src={logopng} width="50px" height={"50px"} className="inline-block" alt="Triptastic Logo" />
//                 {" "}Triptastic
//               </span>
//             </Link>
...
//       {/* Footer */}
//       <footer className="bg-gradient-to-t from-gray-900 via-gray-800 to-black text-gray-400 mt-auto">
...
//           © {new Date().getFullYear()} Triptastic. All rights reserved.
//         </div>
//       </footer>
//     </div>
//   );
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  const navigate = useNavigate();
  const { user, logout } = useAuth(); // user comes from Firebase now
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                <img src={logopng} width="50" height="50" className="inline-block" alt="Triptastic Logo" />{" "}
                Triptastic
              </span>
            </Link>
